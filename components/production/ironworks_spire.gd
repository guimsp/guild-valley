...
func _ready() -> void:
	...
	GameState.add_text_tag(self, custom_name if custom_name != "" else "Imperial Ironworks Spire")
	...
	if bench:
		bench.bench_name = "Masterwork Cathedral Foundry"
		bench.recipes.clear()
		var r1 = load("res://common/items/recipes/forge_vault_safe.tres")
		var r2 = load("res://common/items/recipes/cast_cathedral_bell.tres")
