...
func _ready() -> void:
	...
	add_to_group("Wheelwrights")
	add_to_group("MarketStall")
	add_to_group("nav_carve_obstacles")
	GameState.add_text_tag(self, custom_name if custom_name != "" else "Wheelwright & Cart Shop")
	...
	# Load Wheelwright recipes inside the bench
	var bench = get_node_or_null("CraftingBench")
	if bench:
		bench.bench_name = "Wheelwright's Bench"
		bench.recipes.clear()
		
		# Level 1 Recipes
		var r1 = load("res://common/items/recipes/build_reinforced_wheel.tres")
		var r2 = load("res://common/items/recipes/assemble_handcart.tres")
		var r3 = load("res://common/items/recipes/local_hauling_service.tres")
		...
		# Level 2 Recipes
		if building_level >= 2:
			var r4 = load("res://common/items/recipes/construct_freight_wagon.tres")
			var r5 = load("res://common/items/recipes/imperial_transit_service.tres")
