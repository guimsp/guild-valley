...
func interact(player: CharacterBody2D) -> void:
	...
	var remainder = GameState.player_inventory.add_item(wheat_res, 1)
	if remainder > 0:
...
func _update_visuals() -> void:
	...
	if is_grown:
		# Golden yellow
		crop_visual.color = Color(0.89, 0.69, 0.19, 1.0)
	else:
		# Dark dry brown soil
